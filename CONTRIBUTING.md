...
```sh
git clone git@github.com:your-user-name/github-status
cd github-status
...
After pushing your code to origin it is now on GitHub but not yet part of the github-status project.
...
of the github-status project know you have code ready to be reviewed. To submit the pull request:
